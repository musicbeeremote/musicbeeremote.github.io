...
I was in the process of doing a complete rewrite of both the plugin and mobile application. I believe that the plugin’s rewrite was done and it should be close to release status without many bugs. It even has few new additions on the protocol level to support a couple of new features, like podcast listing.

The Android rewrite unfortunately was not complete in time, and at the current state the application is crashing and not working as expected.
