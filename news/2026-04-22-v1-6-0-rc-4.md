...
- If you're on the [Play Store beta](https://play.google.com/store/apps/details?id=com.kelsos.mbrc), just keeping the app installed and using it helps, because Crashlytics reports from the Play flavor are what's driving these fixes.
