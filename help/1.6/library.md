...
Navigate deeper into your library:

- **Genre** → Artists or Albums in that genre
...
To populate the library, use the **Sync** option from the toolbar menu or pull down to refresh on any tab. The sync runs in the background with a progress notification showing each category being synced.
